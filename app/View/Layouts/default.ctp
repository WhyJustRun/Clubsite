...
<head>
    ...
    echo "<![endif]-->";
    echo $this->Html->script("/cjs/jquery-1.6.2.min.js,jquery.fancybox-1.3.4.pack.js,placeholder.js,jquery-ui-1.8.16.custom.min.js,jquery-ui-timepicker-addon.js,underscore-min.js,knockout.js,jquery.ketchup.all.min.js,jquery.jeditable.mini.js,jquery.timeago.js,wjr.js,jquery.iecors.js");
