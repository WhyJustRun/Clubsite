...
echo $this->Html->css('/ccss/bootstrap.min.css,font-awesome.css,fullcalendar.css,datepicker.css,jquery.fancybox.css,leaflet.css,bootstrap-wysihtml5.css,whyjustrun.css');
...
echo "<![endif]-->";
echo $this->Html->script("/cjs/jquery-1.8.2.min.js,jquery.mousewheel-3.0.6.pack.js,jquery.ketchup.all.min.js,ketchup-bootstrap.js,jquery.fancybox.pack.js,jquery.placeholder.min.js,underscore-min.js,knockout.js,jquery.jeditable.mini.js,jquery.timeago.js,jquery.iecors.js,date.format.js");
echo $this->Html->script('/cjs/bootstrap.min.js,bootstrap-datepicker.js,bootstrap-typeahead.js,wysihtml5.min.js,bootstrap-wysihtml5.min.js');
