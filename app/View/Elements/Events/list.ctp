<div class="row">
    <div class="col-sm-6 col-sm-offset-3">
        ...
        <div class="event-list" data-event-list-coloring="club-only" data-event-list-type="time-window" data-event-list-older-button="#older-button" data-event-list-newer-button="#newer-button" data-event-list-url="<?= Configure::read('Rails.domain') ?>/club/<?= Configure::read('Club.id') ?>/events.xml?iof_version=3.0&external_significant_events=all">
